...
/**
 * Filter which intercepts servlet calls, and inserts a connection from the
 * connection pool. Removes the connection when the servlet finishes the
 * processing.
 */
...
public class ConnectionSetterFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		try {
			...
			throw new IOException("Database is not accessible.", e);
		}
