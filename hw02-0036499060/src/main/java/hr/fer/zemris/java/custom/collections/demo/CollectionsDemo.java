...
/**
 * Class is copied from the homework assignment. Do not view this as
 * a part of my code; this is here so You could test my code easier.
 * 
 */
public class CollectionsDemo {
	...
	public static void main(String[] args) {
		...
		col.remove(1); // removes 20 from collection (at position 0).
	}
}
